...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        var session1 = new Session(user1, user2, aircraft1, 1100, LocalDate.now().minusDays(1), Session.State.PENDING, "Rough Landing, work on approach. ", 2);
        var session2 = new Session(user1, user2, aircraft2, 1400, LocalDate.now(), Session.State.APPROVED, "No outstanding issues. ", 4);
