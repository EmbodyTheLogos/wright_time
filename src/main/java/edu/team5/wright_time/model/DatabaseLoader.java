...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        var session1 = new Session(user3, user2, aircraft1, 11, LocalDate.now().plusDays(1), Session.State.PENDING, "", 0);
        var session2 = new Session(user4, user2, aircraft2, 14, LocalDate.now(), Session.State.APPROVED, "", 0);
        var session3 = new Session(user3, user2, aircraft2, 10, LocalDate.of(2019, 2, 25), Session.State.PENDING, "", 0);
        var session4 = new Session(user3, user2, aircraft3, 9, LocalDate.of(2018, 9, 4), Session.State.COMPLETE, "Good work", 5);
        var session5 = new Session(user3, user2, aircraft4, 17, LocalDate.of(2019, 12, 31), Session.State.CANCELLED, "", 0);
        var session6 = new Session(user3, user2, aircraft1, 15, LocalDate.of(2020,2,28), Session.State.DECLINED, "", 0);
        var session7 = new Session(user3, user2, aircraft3, 11, LocalDate.now().minusDays(3), Session.State.APPROVED,"",0);
